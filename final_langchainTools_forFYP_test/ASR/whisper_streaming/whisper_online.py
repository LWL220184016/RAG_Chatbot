...
def add_shared_args(parser):
    ...
    parser.add_argument('--backend', type=str, default="nemo_parakeet", choices=["faster-whisper", "nemo_parakeet", "whisper_timestamped", "mlx-whisper"],help='Load only this backend for Whisper processing.')
...
#     asr = asr_cls(modelsize=size, cache_dir=args.model_cache_dir, model_dir=args.model_dir)
#     e = time.time()
...
#         online = VACOnlineASRProcessor(args.min_chunk_size,tokenizer,logfile=logfile,buffer_trimming=(args.buffer_trimming, args.buffer_trimming_sec))
#     else:
#         online = OnlineASRProcessor(tokenizer,logfile=logfile,buffer_trimming=(args.buffer_trimming, args.buffer_trimming_sec))
