...
python speech_to_text_streaming_infer.py \
    ...
    --audio_file=output_txt2.wav \
    --batch_size=16 \
    --compare_vs_offline \
    --use_amp \
    --debug_mode

python speech_to_text_streaming_infer.py --asr_model=stt_en_conformer_ctc_large --chunk_size=100 --shift_size=50 --left_chunks=2 --online_normalization --audio_file=output_txt2.wav --batch_size=16 --compare_vs_offline --use_amp --debug_mode
